...
// Particles
    ...
    class Particle {
        ...
        draw() {
            ...
            ctx.fillStyle = 'rgba(175,175,175, ' + a * alpha_multiplier + ')';
            ctx.fill();
        }
        ...
        update() {
            ...
            let dy = mouse.y + window.scrollY - offset - this.y;
    ...
    for (let a = 0; a < particleArray.length; a++) {
        for (let b = a; b < particleArray.length; b++){
            ...
            {   
                ...
                ctx.strokeStyle='rgba(255,255,255,' + opacityValue * alpha_multiplier +')';
                ctx.beginPath();
                ctx.lineWidth = 1;
